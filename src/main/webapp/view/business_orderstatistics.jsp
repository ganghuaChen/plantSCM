	   ...
	   window.location.href = path+"factory_openfactoryrecord.jsp";  
        ...
        function search2(){       	
        	...
        	if(temp.startTime==""){
        		...
        		toastr.info("请选择结束时间");
              	...
              	$.ajax({
                    type:"GET",
                    url:"/plantSCM//BusinessStatistics/getHanjiOrderStatistics",//获取焊剂销售统计信息  向后台传开始时间结束时间
                    data:temp,
                    dataType:"json",
        ...
        function search1(){       	
        	...
        	if(temp.startTime==""){
        		...
        		$.ajax({
                    type:"GET",
                    url:"/plantSCM//BusinessStatistics/getHanpianOrderStatistics",//获取焊片销售统计信息  向后台传开始时间结束时间
                    data:temp,
                    dataType:"json",
                    success:function(data){
                    	if(data.code==0){
                            ...
                            // uniqueId: "id",                     //每一行的唯一标识，一般为主键列         
                             ...
                             columns: [                    	
                                ...
                                return index+1;
                                 ...
                                 field: 'hporderNumberStatistics',
                                 title: '重量',
                                 sortable : true,
                                 
                             }, {
                                 field: 'hporderTotalPriceStatistics',
                                 title: '总价',
                                 sortable : true
                             }],
                             data:result
                            ...
                            // uniqueId: "id",                     //每一行的唯一标识，一般为主键列         
                             ...
                             columns: [                    	
                                ...
                                return index+1;
                                 ...
                                 field: 'hjorderNumberStatistics',
                                 title: '数量',
                                 sortable : true
                             }, {
                                 field: 'hjorderTotalPriceStatistics',
                                 title: '总价',
                                 sortable : true,
...
<body>
          ...
          <header>
           ...
           <div class="col-xs-11 col-md-11">       
               ...
               <div class="row">                  
                   <button id="submit"  type="button" class="btn btn-default"  onclick="purchase()">采购统计</button>
                   <button id="back"  type="button" class="btn btn-primary"    onclick="order()">销售统计</button>                
              </div>  
                <br/>                
      
                
                 <div class="row">                                                  
               <div style="white-space:pre;float:left;">日期</div>
