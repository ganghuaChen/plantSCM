    ...
    $(function (){
    	...
    	$.ajax({
            ...
            success:function(data){  
	            ...
	            {
	               datas[i]={"number":data.result[i].hpkcId,"shape":data.result[i].shape,"model":data.result[i].model,"spec":data.result[i].spec,"actualNumber":data.result[i].actualNumber};	              
	            }       
    	$('#tabletest').bootstrapTable({
			...
			[
				...
				{field:"shape",title:"形状",align:"center",valign:"middle"},
				{field:"model",title:"型号",align:"center",valign:"middle"},
				{field:"spec",title:"规格",align:"center",valign:"middle"},
				{field:"actualNumber",title:"重量",align:"center",valign:"middle"},			
			],
...
<body>
          ...
          <header>
            ...
            <li style="background-color:#F0FFFF;"><a href="javascript:void(0)" onclick="clickhpprint()">焊片打印</a></li>
